...
enum {
	...
	/* No DEV_OPT_* counterpart; carry data consumed outside flags. */
	DEV_ATTR_TYPE,
	DEV_ATTR_ENABLED,
	DEV_ATTR_VLAN,
	DEV_ATTR_AUTH_VLAN,
 ...
 * DEV_OPT_* mask. DEV_OPT_DEFAULT_MACADDR has no DEV_ATTR_* peer (it
 * is synthesised by system_if_get_settings()) and is parked above the
 * attr range.
 */
enum {
	DEV_OPT_IPV6				= 1ULL << DEV_ATTR_IPV6,
	DEV_OPT_IP6SEGMENTROUTING		= 1ULL << DEV_ATTR_IP6SEGMENTROUTING,
	DEV_OPT_RPFILTER			= 1ULL << DEV_ATTR_RPFILTER,
	DEV_OPT_ACCEPTLOCAL			= 1ULL << DEV_ATTR_ACCEPTLOCAL,
	DEV_OPT_IGMPVERSION			= 1ULL << DEV_ATTR_IGMPVERSION,
	DEV_OPT_MLDVERSION			= 1ULL << DEV_ATTR_MLDVERSION,
	DEV_OPT_NEIGHREACHABLETIME		= 1ULL << DEV_ATTR_NEIGHREACHABLETIME,
	DEV_OPT_NEIGHGCSTALETIME		= 1ULL << DEV_ATTR_NEIGHGCSTALETIME,
	DEV_OPT_NEIGHLOCKTIME			= 1ULL << DEV_ATTR_NEIGHLOCKTIME,
	DEV_OPT_DADTRANSMITS			= 1ULL << DEV_ATTR_DADTRANSMITS,
	DEV_OPT_SENDREDIRECTS			= 1ULL << DEV_ATTR_SENDREDIRECTS,
	DEV_OPT_DROP_V4_UNICAST_IN_L2_MULTICAST	= 1ULL << DEV_ATTR_DROP_V4_UNICAST_IN_L2_MULTICAST,
	DEV_OPT_DROP_V6_UNICAST_IN_L2_MULTICAST	= 1ULL << DEV_ATTR_DROP_V6_UNICAST_IN_L2_MULTICAST,
	DEV_OPT_DROP_GRATUITOUS_ARP		= 1ULL << DEV_ATTR_DROP_GRATUITOUS_ARP,
	DEV_OPT_DROP_UNSOLICITED_NA		= 1ULL << DEV_ATTR_DROP_UNSOLICITED_NA,
	DEV_OPT_ARP_ACCEPT			= 1ULL << DEV_ATTR_ARP_ACCEPT,
	DEV_OPT_MTU6				= 1ULL << DEV_ATTR_MTU6,
	DEV_OPT_TXQUEUELEN			= 1ULL << DEV_ATTR_TXQUEUELEN,
	DEV_OPT_PROMISC				= 1ULL << DEV_ATTR_PROMISC,
	DEV_OPT_MULTICAST			= 1ULL << DEV_ATTR_MULTICAST,

	DEV_OPT_MTU				= 1ULL << DEV_ATTR_MTU,
	DEV_OPT_MACADDR				= 1ULL << DEV_ATTR_MACADDR,
	DEV_OPT_MULTICAST_TO_UNICAST		= 1ULL << DEV_ATTR_MULTICAST_TO_UNICAST,
	DEV_OPT_MULTICAST_ROUTER		= 1ULL << DEV_ATTR_MULTICAST_ROUTER,
	DEV_OPT_MULTICAST_FAST_LEAVE		= 1ULL << DEV_ATTR_MULTICAST_FAST_LEAVE,
	DEV_OPT_LEARNING			= 1ULL << DEV_ATTR_LEARNING,
	DEV_OPT_UNICAST_FLOOD			= 1ULL << DEV_ATTR_UNICAST_FLOOD,
	DEV_OPT_BROADCAST_FLOOD			= 1ULL << DEV_ATTR_BROADCAST_FLOOD,
	DEV_OPT_ISOLATE				= 1ULL << DEV_ATTR_ISOLATE,
	DEV_OPT_AUTH				= 1ULL << DEV_ATTR_AUTH,
	DEV_OPT_SPEED				= 1ULL << DEV_ATTR_SPEED,
	DEV_OPT_DUPLEX				= 1ULL << DEV_ATTR_DUPLEX,
	DEV_OPT_PAUSE				= 1ULL << DEV_ATTR_PAUSE,
	DEV_OPT_ASYM_PAUSE			= 1ULL << DEV_ATTR_ASYM_PAUSE,
	DEV_OPT_RXPAUSE				= 1ULL << DEV_ATTR_RXPAUSE,
	DEV_OPT_TXPAUSE				= 1ULL << DEV_ATTR_TXPAUSE,
	DEV_OPT_AUTONEG				= 1ULL << DEV_ATTR_AUTONEG,
	...
	DEV_OPT_PSE_PRIORITY			= 1ULL << DEV_ATTR_PSE_PRIORITY,

	DEV_OPT_DEFAULT_MACADDR			= 1ULL << 63,
};

#define DEV_OPT_LIVE_APPLY_MASK \
	(((uint64_t)1 << __DEV_ATTR_LIVE_APPLY_MAX) - 1)
